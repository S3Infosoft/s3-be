...
class Modals extends Component {
  ...
  render() {
    ...
    const { fields, sys } = this.props.ele;
    return (
      <React.Fragment>
        <div className="container" style={{ width: "100%" }}>
          <div className="card">
            <div className="row">
              ...
              <div className="col-md-4 col-sm-2 col-lg-4 col-xs-4">
                <div className="jumbotron bg-light text-warning">
                  Room Id: {sys.id}
                  <br />
                  Capacity:{fields.capacity}
                  <br />
                  Price (Inr):Rs {fields.price}
                  <br />
                  Room type:Rs{" "}
                  <b className="font-weight-bold text-primary font-weight-bold">
                    {fields.slug}
                  </b>
                  <br />
                  wifi-status:
                  <div className="text-danger font-weight-bold font-weight-bold">
                    Available
                  </div>
                  breakfast:
                  {fields.breakfast ? (
