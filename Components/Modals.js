      ...
      <Card className="sds">
        <CardActionArea>
          <CardMedia
            ...
            height="140"
            image="https://images.pexels.com/photos/1457842/pexels-photo-1457842.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500"
            ...
            <DialogContent>
              <DialogContentText id="alert-dialog-description">
                <div className={classes.root}>
                  ...
                  <SnackbarContent
                    className={classes.snackbar}
                    message={`Price For Night :: $${fields.price}`}
                  />
                  <SnackbarContent
                    className={classes.snackbar}
